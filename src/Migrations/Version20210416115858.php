 ...
 */
final class Version20210416115858 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE opportunite ADD association_id INT DEFAULT NULL, CHANGE lanceur_id lanceur_id INT DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT NULL, CHANGE region region VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE date_limite date_limite DATE DEFAULT NULL, CHANGE domaine_concerne domaine_concerne VARCHAR(255) DEFAULT NULL, CHANGE lien_form_postul lien_form_postul VARCHAR(255) DEFAULT NULL, CHANGE type_offre type_offre VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_97889F98EFB9C8A5 ON opportunite (association_id)');
